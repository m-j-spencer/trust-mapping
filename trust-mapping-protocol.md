...
All organisations depend on security practitioners to ensure good cyber security. In large organisations these may be members of a specialist security teams. In smaller organisations, they may work across IT, risk, and procurement. 
...
There are no rules for how actors should be positioned in relation to each other; participants will tend to use spatial logics that are intuitive to them, clustering actors that are 'near' or 'similar' to each other in ways relevant to them.
...
This methodology was developed and piloted during 2022 and 2023 with the generous assistance of security practitioners at two large organisations: their feedback and insight was invaluable in refining the protocol.
